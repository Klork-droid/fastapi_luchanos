...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
                {'surname': ''},
                422,
                {'detail': [{'ctx': {'min_length': 1}, 'input': '', 'loc': ['body', 'surname'],
                             'msg': 'String should have at least 1 characters', 'type': 'string_too_short',
                             'url': 'https://errors.pydantic.dev/2.3/v/string_too_short'}]},
        ),
        (
                {'name': ''},
                422,
                {'detail': [{'ctx': {'min_length': 1}, 'input': '', 'loc': ['body', 'name'],
                             'msg': 'String should have at least 1 characters', 'type': 'string_too_short',
                             'url': 'https://errors.pydantic.dev/2.3/v/string_too_short'}]},
        ),
